...
-(id) init
{
    ...
    {
        // Setup strings
        [mLine1 setString:NSLocalizedString(@"TIP_INTRO_LINE1", nil)];
        [mLine2 setString:NSLocalizedString(@"TIP_INTRO_LINE2", nil)];
        [mLine3 setString:NSLocalizedString(@"TIP_INTRO_LINE3", nil)];
        [mLine4 setString:NSLocalizedString(@"TIP_INTRO_LINE4", nil)];
        
        // Setup graphics
        // The blue elevator
		CCNode* wCar = [CCSprite spriteWithSpriteFrameName:@"el-blue-game.png"];
        ...
        // Passenger count
        CCLabelBMFont* wLabelPassengers = [CCLabelBMFont labelWithString:@"6" fntFile:[GameController selectFont:kDroidSansBold20Black]];
