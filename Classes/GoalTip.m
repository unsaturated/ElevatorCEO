...
-(id) init
{
    ...
    {
        // Setup strings
        [mLine1 setString:NSLocalizedString(@"TIP_GOAL_LINE1", nil)];
        [mLine2 setString:NSLocalizedString(@"TIP_GOAL_LINE2", nil)];
        [mLine3 setString:NSLocalizedString(@"TIP_GOAL_LINE3", nil)];
        [mLine4 setString:NSLocalizedString(@"TIP_GOAL_LINE4", nil)];
        ...
        // Passenger count
		CCLabelBMFont* wLabelPassengers = [CCLabelBMFont labelWithString:@"1" fntFile:[GameController selectFont:kDroidSansBold20Black]];
